...
import com.example.telalogin.databinding.ActivityMoedaBinding

class MoedaActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMoedaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityMoedaBinding.inflate(layoutInflater)
